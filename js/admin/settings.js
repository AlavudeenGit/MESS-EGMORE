...
export async function renderSettings(root) {
  ...
  root.innerHTML = `
    <div class="card">
      ...
      <p class="text-soft" style="font-size:13px;">Shared by both tabs in Mark Food — today's confirmation AND tomorrow's booking are only open during this window (default 8:30 PM–11:30 PM). Outside it, students can't select or submit anything.</p>
